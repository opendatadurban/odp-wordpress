<?php
    /**
    * Template Name: Research Dashboard Page
    */
?>  
...
<div class="top-page-blue-bar">
    <div></div>
    <div>
      <span>Home / 2022 Census</span>
    </div>
    <div>
        <span style="width:300px;">
        Welcome to the Research Datasets section, where you can explore key data powering insights.    
        </span>
    </div>
</div>
...
<div class="top-page-blue-bar-with-tab-buttons">
  ...
  <div>  
  Contact Us: <a style="color:white;" href="mailto:mailto:Research.Analytics@capetown.gov.za?subject=Query" class="link-6">Research.Analytics@capetown.gov.za</a>
  </div>
      ...
      <div class="tab_content_iframe"  style="border: 0px solid grey;background-color:white;">
          ...
          <div style="display:grid; grid-template-columns: 4fr 1fr 1fr 1fr; border-bottom: 1px solid #ccc; border-left: 1px solid #ccc; align-items:center;height: 55px;">
              ...
              <div style="color:#4c4c4c;">
                <h2 style="padding-left:20px;">Internet Connection Trends
                </h2>              
              </div>

              <div>
                <span style="color:#afaeba">AUTHOR:</span>
                <span style="color:#4c4c4c;font-weight: 500;">Research Analytics</span>
              </div>
          ...
          <div>
            ...
            <iframe id="iframe1" src="https://cct-census-2022-ghs-2023.netlify.app/01_internet.html" width="100%" height="1500px" frameborder="0"></iframe>
